...
export const AccouttWishlist: React.FC<React.SVGAttributes<{}>> = () => {
  ...
  return (
    <button type="button" className="relative p-1">
      ...
      <div className="absolute inline-flex items-center justify-center w-[22px] h-[22px] text-xs font-bold text-white bg-red-600 border-2 border-white rounded-full top-[3px] right-[0.01px]  dark:border-gray-900">
